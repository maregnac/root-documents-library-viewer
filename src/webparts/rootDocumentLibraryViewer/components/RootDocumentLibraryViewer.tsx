...
export default class RootDocumentLibraryViewer extends React.Component<IRootDocumentLibraryViewerProps> {
  public render(): React.ReactElement<IRootDocumentLibraryViewerProps> {
    ...
    return (
      <section className={`${styles.rootDocumentLibraryViewer} ${hasTeamsContext ? styles.teams : ''}`}>
